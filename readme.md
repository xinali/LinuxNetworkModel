...
本文主旨是`show me the code`，废话不多，能用代码描述的尽力不多bb，每个模型，我都简要的做了描述，之后使用简单的代码来做指导，并且代码可以使用，[开源代码](https://github.com/xinali/LinuxNetworkModel)，你可以编译执行，观察效果，之后再结合一点理论，自然而然也就大概理解了。等你了解了，这些基础，再去使用什么`libev/libuv`的库，相对来说也就简单多了。
